...
public enum KmgFundGenMsgTypes implements KmgFundCmnGenMsgTypes, KmgFundCmnExcMsgTypes {
    ...
    /**
     * ファイルイテレータで現在のファイルに内容を書き込み中に例外が発生しました。現在のファイルパス=[{0}]、書き込む内容=[{1}]
     *
     * @since 0.2.3
     */
    KMGFUND_GEN13000("ファイルイテレータで現在のファイルに内容を書き込み中に例外が発生しました。現在のファイルパス=[{0}]、書き込む内容=[{1}]"),

    /**
     * ファイルイテレータで現在のファイルをロード中に例外が発生しました。現在のファイルパス=[{0}]
     *
     * @since 0.2.3
     */
    KMGFUND_GEN13001("ファイルイテレータで現在のファイルをロード中に例外が発生しました。現在のファイルパス=[{0}]"),

    /**
     * ファイルイテレータで対象ファイルをロード中に例外が発生しました。対象ファイルパス=[{0}]
     *
     * @since 0.2.3
     */
    KMGFUND_GEN13002("ファイルイテレータで対象ファイルをロード中に例外が発生しました。対象ファイルパス=[{0}]"),

    /**
     * ファイルイテレータで対象ファイルが見つかりません。対象ファイルパス=[{0}]
     *
     * @since 0.2.3
     */
    KMGFUND_GEN13003("ファイルイテレータで対象ファイルが見つかりません。対象ファイルパス=[{0}]"),
